...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
         ...
         */
        developerRunner.addDeveloper("Stanislaw", "Developer", "Java/Scala Developer", 2);
        developerRunner.addDeveloper("Alexander", "Developer", "Golang Developer", 2);
        developerRunner.addDeveloper("Maxim", "Mobile Developer", "IOS Developer", 4);
         ...
         */
        developerRunner.updateDeveloper(11, 3);
